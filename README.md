...
## MCNH-AR model: context variables $\mathcal{C}_1$ - Application to anesthesia data
...
## MCNH-AR model: context variables $\mathcal{C}_2$ - Application to anesthesia data
